...
// Booking Eligibility Interface - Defines eligibility rules
...
// Standard and VIP Room Booking extending AbstractRoomBooking
...
// FoodOrder Class implementing FoodOrderable
...
// Billable Interface - Abstraction for billing
interface Billable {
...
/**
 * Main Class implementing Dependency Inversion Principle
 */
public class DIP {
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in);

        // Create dependencies using abstractions
        RoomOperations standardRoom = new Room(1);
        RoomOperations vipRoom = new Room(2);

        RoomBooking standardBooking = new StandardRoomBooking(new AllCustomersAllowed());
        RoomBooking vipBooking = new VIPRoomBooking(new OnlyVIPAllowed());
